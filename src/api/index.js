...
// Nominated guests
export const updateNominatedGuests = (data) =>
  api.put("/data/nominated-guests", data);

// Guest settings
export const updateGuestSettings = (data) =>
  api.put("/data/guest-settings", data);
...
export const updateExpenseSettings = (data) =>
  api.put("/data/expense-settings", data);
export const addExpense = (data) => api.post("/data/expenses", data);
export const updateExpense = (id, data) =>
  api.put(`/data/expenses/${id}`, data);
...
export const updateChecklistItem = (id, data) =>
  api.put(`/data/checklist/${id}`, data);
...
export const updateProgramItem = (id, data) =>
  api.put(`/data/program/${id}`, data);
...
export const updateSupplier = (id, data) =>
  api.put(`/data/suppliers/${id}`, data);
export const deleteSupplier = (id) => api.delete(`/data/suppliers/${id}`);
export const resetSuppliers = () => api.delete("/data/suppliers");

// Event
export const addEvent = (data) => api.post("/data/event", data);
export const updateEvent = (data) => api.put("/data/event", data);
export const deleteEvent = () => api.delete("/data/event");
